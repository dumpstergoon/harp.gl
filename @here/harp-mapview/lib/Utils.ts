...
export namespace MapViewUtils {
    ...
    export function zoomOnTargetPosition(
        ...
        if (mapView.projection.type === ProjectionType.Spherical) {
            const tilt = extractCameraTilt(mapView);
    ...
    export function orbitFocusPoint(
        ...
        const target = mapView.targetPoint;
     ...
     */
    export function getTargetCoordinatesFromCamera(
        camera: THREE.Camera,
        ...
        const targetWorldPos = getTargetPositionFromCamera(camera, projection, elevation);
     ...
     */
    export function getTargetPositionFromCamera(
        camera: THREE.Camera,
        projection: Projection,
        elevation?: number
    ): THREE.Vector3 | null {
     ...
     */
    export function extractCameraTilt(mapView: MapView): number {
